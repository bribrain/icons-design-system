...
export default function BrowserNotSupportedIcon({ size = 24, rotate = 0, color = "grey-100" }: IBrowserNotSupportedIconProps) {
  const colorCode = colorDatas[color]
  return (
    <svg width={size} height={size} transform={`rotate(${rotate})`} viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M19 6.3833V16.8833L20.95 18.8333C20.98 18.6833 21 18.5333 21 18.3833V6.3833C21 5.2833 20.1 4.3833 19 4.3833H6.5L8.5 6.3833H19Z" fill={colorCode} />
      <path
