...
export interface IStayPrimaryPotraitIconProps {
  size?: number
  rotate?: number
  color?: Color
}

export default function StayPrimaryPotraitIcon({ size = 24, rotate = 0, color = "grey-100" }: IStayPrimaryPotraitIconProps) {
