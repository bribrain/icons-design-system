...
export interface IStayPrimaryLandscapeIconProps {
  size?: number
  rotate?: number
  color?: Color
}

export default function StayPrimaryLandscapeIcon({ size = 24, rotate = 0, color = "grey-100" }: IStayPrimaryLandscapeIconProps) {
